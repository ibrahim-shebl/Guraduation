            ...
            <div className={`nav d-flex align-items-center ${isOpenNav === true && 'click'}`}>
                <div className='container-fluid'>
                    <div className='row position-relative'>
                        ...
                        <div className='col-sm-9 part2 position-static'>
                            <nav className={isOpenNav === true ? 'open' : ''}>
                                <ul className='list list-inline mb-0'>
                                    ...
                                    <li className='list-inline-item'>
                                        <Button onClick={props.closeNav}><Link to="/">Appliances</Link></Button>
                                    </li>
                                    <li className='list-inline-item'>
                        ...
                        <div className='col-sm-3 part3 d-flex align-items-center'>
