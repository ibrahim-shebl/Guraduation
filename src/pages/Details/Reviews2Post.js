                ...
                <div className='col-md-4 reviewBox'>
                    ...
                    <div className="progressBarBox d-flex align-items-center">
                        ...
                        <div class="progress" style={{ width: '85%', height: '20px' }}>
                            <div class="progress-bar bg-success" style={{ width: '97%', height: '20px' }}>97%</div>
                        </div>
                    </div>
                    ...
                    <div className="progressBarBox d-flex align-items-center">
                        ...
                        <div class="progress" style={{ width: '85%', height: '20px' }}>
                            <div class="progress-bar bg-success" style={{ width: '60%', height: '20px' }}>60%</div>
                        </div>
                    </div>
